...
train_file = '../../DataSets/Demand_Train_Pred_processed.csv'
...
for i, (train, valid) in enumerate(folds):
	model[i] = gl.boosted_trees_regression.create(train, max_iterations=250, max_depth=4, step_size=0.10,target='demand_act',metric='rmse',verbose=False)
